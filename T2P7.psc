Algoritmo T2P7
	...
	//Se desea elaborar un algoritmo que determine cuántas personas de un grupo
	//tienen hijos y cuántos no tienen, además se desea conocer el promedio del número de hijos.
	
	definir grupo, i, respuesta, cantHijos, contSinHijos, sumaHijos, contConHijos como entero
	
	//i: controlador del Mientras 
